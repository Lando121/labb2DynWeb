...
//view2 screen after pending update
	...
	for(m = 0; m<menu.length; m++){
		...
		$("#view2after").append("<div class='col-xs-12 col-sm-6 left_align_par orange_paragraph_view2' id='view2after_name'" +"'>"+ menu[m].name + "</div>" 
			+ "<div class='col-xs-12 col-sm-6 right_align_par orange_paragraph_view2' id='view2after_pending_cost'"+ "'>" + totalPrice + "</div><div class='clearfix'></div>");
...
$(function() {
	...
	var view3 = new view2afterFunc($("#View2_after"),model);
});
